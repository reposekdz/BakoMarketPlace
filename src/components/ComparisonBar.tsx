...
export function ComparisonBar({ products, onRemove, onClear, currency }: ComparisonBarProps) {
  return (
          ...
          {products.map((product) => {
            ...
            return (
              <div key={product.id} className="relative bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-purple-600">{formatCurrency(convertedPrice, currency)}</p>
              </div>
            )
          })}
